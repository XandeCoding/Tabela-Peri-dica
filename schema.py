...
class Pesquisa():
    ...
    def __init__(self, sigla: str, nome: str):
        """Inicializa a classe que mantém os dados de pesquisa de elementos."""
        self.sigla = sigla
        self.nome = nome
...
class Elemento():
    ...
    def __str__(self):
        ...
        return '{} {}\nFamilia: {}\nNumero atomico: {}\nMassa Molar {}'.format(self.sigla, self.nome, self.familia, self.atomico, self.m_molar)
...
def init_Elementos() -> list:
    ...
    magnesio = Elemento('Mg', 'Magnésio', 'Metais alcalinos Terrosos', 12, 24.305)
    calcio = Elemento('Ca', 'Cálcio', 'Metais alcalinos Terrosos', 20, 24.305)
    estroncio = Elemento('Sr', 'Estrôncio', 'Metais alcalinos Terrosos', 38, 87.62)
    ...
    rutherfordio = Elemento('Rf', 'Rutherfórdio', 'Metais de Transição', 104, 267)
    ...
    aluminio = Elemento('Al', 'Alumínio', 'Metais de Pós Transiçao', 13, 26.982)
